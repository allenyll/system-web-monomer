...
public class OrderAftersaleController extends BaseController<OrderAftersaleServiceImpl,OrderAftersale> {
    ...
    @ApiOperation("[小程序接口]获取订单及售后申请单列表")
